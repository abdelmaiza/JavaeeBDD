package com.pluralsight.bddfundamentals.airport.milage;
...
public class Mileage {
    ...
    public void setPassengersMileageMap(Map<Passenger, Integer> passengersMileageMap) {
        this.passengersMileageMap = passengersMileageMap;
    }
    ...
    public void setPassengersPointsMap(Map<Passenger, Integer> passengersPointsMap) {
        this.passengersPointsMap = passengersPointsMap;
    }
